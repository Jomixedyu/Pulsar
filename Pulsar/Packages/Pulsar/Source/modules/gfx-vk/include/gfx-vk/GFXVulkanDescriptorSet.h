...
namespace gfx
{
    ...
    public:
        ...
        // (and its pools) outlive the set, and the set recycles itself on destroy.
        std::shared_ptr<GFXDescriptorSet> AllocateSet() override;
    ...
    public:
        ...
        virtual void SetConstantBufferDynamic(GFXBuffer* buffer) override;
