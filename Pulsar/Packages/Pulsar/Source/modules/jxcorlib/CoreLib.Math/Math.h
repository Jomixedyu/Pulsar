...
namespace jxcorlib::math
{
    ...
    //class BoxingColor4b : public jxcorlib::BoxingObject
    //{
    //    CORELIB_DEF_TYPE(AssemblyObject_JxMath, jxcorlib::math::BoxingColor4b, jxcorlib::BoxingObject);
    //public:
    ...
    //    using unboxing_type = Color4b;
    //    Vector2f get_unboxing_value() { return Color4b(r, g, b, a); }

    //    BoxingColor4b() : r(0), g(0), b(0), a(0) {}
    //    BoxingColor4b(Color4b value) : r(value.r), g(value.g), b(value.b), a(value.a) {}

    //    virtual string ToString() const override { return to_string(unboxing_type(r, g, b, a)); }
    //};
    //template<> struct get_boxing_type<Color4b> { using type = BoxingColor4b; };


    class BoxingColor4f : public jxcorlib::BoxingObject
    {
        CORELIB_DEF_TYPE(AssemblyObject_JxMath, jxcorlib::math::BoxingColor4f, jxcorlib::BoxingObject);
    public:
        ...
        using unboxing_type = Color4f;
        Color4f get_unboxing_value() { return Color4f(r, g, b, a); }

        BoxingColor4f() : r(0), g(0), b(0), a(0) {}
        BoxingColor4f(Color4f value) : r(value.r), g(value.g), b(value.b), a(value.a) {}
...
CORELIB_DECL_BOXING(jxcorlib::math::Color4f, jxcorlib::math::BoxingColor4f)
...
CORELIB_DECL_BOXING(jxcorlib::math::Matrix4f, jxcorlib::math::BoxingMatrix4f)
