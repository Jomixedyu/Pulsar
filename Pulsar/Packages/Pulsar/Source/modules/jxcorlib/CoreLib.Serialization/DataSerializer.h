...
namespace jxcorlib::ser
{
    ...
    extern Stream& ReadWriteStream(Stream& stream, bool is_write, uint8_t& out);
    extern Stream& ReadWriteStream(Stream& stream, bool is_write, uint16_t& out);
    extern Stream& ReadWriteStream(Stream& stream, bool is_write, int16_t& out);
    extern Stream& ReadWriteStream(Stream& stream, bool is_write, uint32_t& out);
    extern Stream& ReadWriteStream(Stream& stream, bool is_write, int32_t& out);
    extern Stream& ReadWriteStream(Stream& stream, bool is_write, uint64_t& out);
    extern Stream& ReadWriteStream(Stream& stream, bool is_write, int64_t& out);
    extern Stream& ReadWriteStream(Stream& stream, bool is_write, float& out);
    extern Stream& ReadWriteStream(Stream& stream, bool is_write, double& out);
    extern Stream& ReadWriteStream(Stream& stream, bool is_write, std::string& out);
    ...
    extern void ReadWriteTextStream(ser::Stream& stream, bool write, std::string& str);
