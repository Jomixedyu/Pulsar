...
namespace pulsar
{
    ...
    public:
        ...
        static inline const char* ViewPipeline_DefaultScene = "Pulsar/Settings/DefaultSceneViewPipeline";
        ...
        // Resolve texture default identifiers from shader config, e.g. "T2D_WHITE".
