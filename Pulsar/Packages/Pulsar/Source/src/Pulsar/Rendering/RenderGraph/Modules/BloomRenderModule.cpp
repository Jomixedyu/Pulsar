...
namespace pulsar
{
    ...
    void BloomRenderModule::Initialize()
    {
    ...
    void BloomRenderModule::SetupBloomSet(gfx::GFXDescriptorSet* set, gfx::GFXTexture2DView* srcView)
    {
        if (!set)
            return;
    ...
    void BloomRenderModule::SetupCombineSet(gfx::GFXDescriptorSet* set,
