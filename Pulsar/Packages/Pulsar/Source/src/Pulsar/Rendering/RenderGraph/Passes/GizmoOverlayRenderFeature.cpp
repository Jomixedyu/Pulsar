...
namespace pulsar
{
    void GizmoOverlayRenderFeature::OnRecord(RenderGraph& graph, RenderFrameData& frameData)
    {
    ...
    RGTextureHandle GizmoOverlayRenderFeature::RecordOverlayPass(RenderGraph& graph,
