...
namespace jxcorlib
{
    ...
    template<typename... TArgs>
    class Function<bool, TArgs...> : public DelegateBase<bool, TArgs...>
    {
    public:
        std::vector<bool> InvokeResult(TArgs... args) {
        ...
        bool IsValidReturnInvoke(TArgs... args) {
            for (const bool& item : this->InvokeResult(args...)) {
