...
namespace jxcorlib
{
    ...
    public:
        ...
        virtual void Add(Object_rsp value) override
        {
            ...
            {
                this->push_back(std::static_pointer_cast<typename remove_shared_ptr<RealT>::type>(value));
            }
            else
            {
                this->push_back(UnboxUtil::Unbox<RealT>(value));
            }
        }
        virtual Object_sp At(int32_t index) const override
        {
        ...
        virtual int32_t IndexOf(Object_rsp value) const override
        {
            for (int32_t i = 0; i < this->size(); i++)
            {
                ...
                {
                    if (item == UnboxUtil::Unbox<RealT>(value))
                    {
                        return i;
                    }
                }
        ...
        virtual Type* GetIListElementType() const override { return cltypeof<typename get_boxing_type<RealT>::type>(); }
