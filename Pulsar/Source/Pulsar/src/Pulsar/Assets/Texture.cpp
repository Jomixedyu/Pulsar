...
namespace pulsar
{
    hash_map<TextureCompressionFormat, gfx::GFXTextureFormat>* Texture::StaticGetFormatMapping(OSPlatform platform)
    {
        static hash_map<TextureCompressionFormat, gfx::GFXTextureFormat> map{
            {TextureCompressionFormat::ColorSRGBA_Compressed, gfx::GFXTextureFormat::BC7_SRGB},
            {TextureCompressionFormat::MaskRGBA_Compressed, gfx::GFXTextureFormat::BC7_UNorm},
            ...
            {TextureCompressionFormat::BitmapSRGBA8, gfx::GFXTextureFormat::R8G8B8A8_SRGB},
