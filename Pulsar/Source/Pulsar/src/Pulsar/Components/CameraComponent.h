...
namespace pulsar
{
    ...
    public:
        ...
        bool IsGizmoOverlayEnabled() const { return m_gizmoOverlayEnabled; }
        void SetGizmoOverlayEnabled(bool value) { m_gizmoOverlayEnabled = value; }

    protected:
        void BeginRT();
        void UpdateRT();
    protected:
        bool m_gizmoOverlayEnabled = true;
